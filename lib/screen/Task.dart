...
import 'package:to_do_app/screen/ToDoMain.dart';
import 'package:to_do_app/screen/TodoCard.dart';
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  FirebaseFirestore.instance.collection("Task").add({
                                    "Title":title.text,"Type":(x).toString(),"Description":description.text
                                  });
